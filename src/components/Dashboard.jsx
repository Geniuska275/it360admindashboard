...
function Dashboard() {
   ...
   const activities=[
    {id:1,
     icon:<PiGraduationCapDuotone style={{
      color:"#EB5757"
     }} />,
     time:"Friday 11:10pm",
      ...
      <div className=' mx-4 grid grid-cols-3 mt-4 gap-6 mb-4'>
        <div className=' col-span-2 bg-white shadow-lg w-full h-[500px] rounded-2xl  '> 
         <div className='flex justify-between items-center mx-5 my-4'>
                     ...
                     <button className='border py-2 px-4 rounded border-[#E4E4E7] text-[#828282]'>See all</button>
                   </div>
            ...
            </div>
            {
              courses.map((item)=>(
                <div className='border-[#E4E4E7] border-b  py-4 flex justify-between items-center text-gray-400'>
                  ...
                  <img src={item.img} className='w-[40px] h-[40px] rounded-full'/>
                  <h2>{item.name}</h2>
                  </div>
