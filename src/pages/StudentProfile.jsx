  ...
  return (
    ...
    <div className='p-4'>
        <div className='flex justify-between items-center '>
           ...
           {active=="Ongoing" ?
            <button className='flex p-2 bg-[#DC2626] rounded text-white items-center gap-1'>
                ...
                De-activate User
            </button>: <button className='flex p-2 bg-[#01857C] rounded text-white items-center gap-1'>
                <FaCheck/>
                Activate User
            </button>}
        </div>
        ...
        <div className='bg-white shadow-md p-2 my-5 relative h-[210px]'>
            <div className='grid grid-cols-4 gap-4'>
                <div className=' p-4'>
                    <div className='flex gap-3 items-center'>
                        <img src='https://media.istockphoto.com/id/1550540247/photo/decision-thinking-and-asian-man-in-studio-with-glasses-questions-and-brainstorming-on-grey.jpg?s=1024x1024&w=is&k=20&c=M4QZ9PB4fVixyNIrWTgJjIQNPgr2TxX1wlYbyRK40dE='
                ...
                <Separator my="1" size="4" orientation="vertical" />
                    ...
                    <h1 className='font-bold  '>
                     ...
                     <p className='text-[12px] text-[#9498A3] uppercase'>parent/guardian name</p>
                    </div>
            ...
            <div className='mt-4 flex gap-2 py-4 mx-5 absolute' >
                <div>
                <h2 className={`text-[#9498A3] ${active=="Profile Details" ? 'text-[#EB5757]':""}`} onClick={()=>setActive("Profile Details")}>Profile Details</h2>
                {active=="Profile Details" && <p className='px-8 bg-[#EB5757] p-[3px] mt-2 rounded'></p>}
                </div>
                 <div>
                <h2 className={`text-[#9498A3] ${active=="Ongoing" ? 'text-[#EB5757]':""}`} onClick={()=>setActive("Ongoing")}>Ongoing Courses</h2>
                {active=="Ongoing" && <p className='px-8 bg-[#EB5757] p-[3px] mt-2 rounded'></p>}
                </div>
                 <div>
                <h2 className={`text-[#9498A3] ${active=="Completed" ? 'text-[#EB5757]':""}`} onClick={()=>setActive("Completed")}>Completed Courses</h2>
                {active=="Completed" && <p className='px-8 bg-[#EB5757] p-[3px] mt-2 rounded'></p>}
                </div>
                ...
                <div className='grid grid-cols-5 gap-3 mx-5'>
                  ...
                  <div className='grid grid-cols-5 gap-3 mx-5 my-5'>
                     <div>
                            ...
                            <p className='text-[12px] font-bold text-black'>June 20,2025</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p className='text-[12px] font-bold text-black'>divine love grammer school</p>
                        ...
                        <div>
                         ...
                         <div className='bg-white shadow-md p-4 my-5 rounded-xl '>
                <h1 className='font-bold mx-5 my-3'>Guadian/parent Information</h1>
                <div className='grid grid-cols-5 gap-3 mx-5'>
                     <div>
                            <h2 className=' text-[#9498A3] uppercase '>First name</h2>
                            <p className='text-[12px] font-bold text-black'>Benjamin</p>
	...
	<Table.Header>
		<Table.Row>
			...
			<Table.ColumnHeaderCell>Course Progress</Table.ColumnHeaderCell>
