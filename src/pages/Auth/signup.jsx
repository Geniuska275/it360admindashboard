    ...
    <div className='h-screen w-full flex  flex-wrap space-between items-center'>
      <div className='w-1/2 h-full '>
        ...
        <div className='bg-white mt-[80px] rounded-lg p-8 flex flex-col justify-center items-center'>
          ...
          <p className='font-lato text-[#828282] mt-2'>
            sign in as an administrator
          </p>
          <form className='flex flex-col space-y-4 mt-6'>
            <div>
              <label className='font-lato font-semibold text-black mb-3'>
                Email Address
              </label>
              <br></br>
              <input
                ...
                className='border rounded-md border-gray-300 rounded px-4 py-2 w-[350px] focus:outline-none focus:ring-2 focus:ring-[#FF6500]'
              />
            </div>
            ...
            <div className='flex justify-between items-center mb-4'>
              <div>
                ...
                <label className='font-lato text-[#828282] text-[12px]'>
                  Remember me
                </label>
              </div>
              <a
                href='#'
                className='font-lato text-[#FF6500] float-right text-[12px]'
              >
                Forgot Password?
              </a>
            </div>
