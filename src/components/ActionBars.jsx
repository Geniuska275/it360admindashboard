...
<AlertDialog.Root>
  ...
  {type=="Admin" ?  <AlertDialog.Content maxWidth="900px" maxHeight={type=="Admin" ? "650px":"450px"}>
         ...
         <div className='flex justify-center items-center'>     
            <form className='w-[800px] h-[500px]   p-2 rounded border border-[#dddddd] mx-5 my-3'>
               ...
               <div className='bg-[#01857C] w-8 h-8 rounded-full flex justify-center items-center absolute top-[50px] right-[290px] border border-white text-white'>
                ...
                <div>
                    <h1 className='text-black font-bold text-center'> Upload profile photo</h1>
                    <p className='text-center text-md'> drag and drop a photo here or upload photo</p>
                    <p className='text-center text-[#727C87] text-sm'> PNG, JPEG (Max: 10mb)</p>           
                </div>
