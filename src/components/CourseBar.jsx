...
function CourseBar({ type }) {
  ...
  return (
    <div className='relative' ref={menuRef}>
      <div
        className='bg-[#E0E0E0] w-8 h-8 rounded flex justify-center items-center cursor-pointer hover:bg-[#D0D0D0] transition-colors'
      ...
      {show && (
        <div className='absolute right-0 top-10 w-[180px] min-h-[120px] p-2 z-[99999] shadow-xl bg-white rounded-xl border border-[#dddddd]'>
          <Link
            to={type == 'instructor' ? '/Instructor' : '/Course'}
            onClick={() => setShow(false)}
          >
            <div className='flex items-center gap-2 hover:bg-[#f5f5f5] p-2 rounded cursor-pointer transition-colors'>
