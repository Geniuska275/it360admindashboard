        ...
        <div className='bg-white shadow-md p-2 my-5 relative h-[210px]'>
            <div className='grid grid-cols-4 gap-4'>
                <div className=' p-4'>
                    <div className='flex gap-3 items-center'>
                        <img src='https://plus.unsplash.com/premium_photo-1690407617542-2f210cf20d7e?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8ZmVtYWxlJTIwcHJvZmlsZSUyMHBpY3xlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&q=60&w=500'
                ...
                <Separator my="1" size="4" orientation="vertical" />
                    ...
                    <h1 className='font-bold  '>
                     ...
                     <p className='text-[12px] text-[#9498A3] uppercase'>NO OF CHILDREN</p>
                    </div>
            ...
            <div className='mt-4 flex gap-2 py-4 mx-5 absolute' >
                ...
                {active=="Profile Details" && <p className='px-8 bg-[#EB5757] p-[3px] mt-2 rounded'></p>}
                 ...
                 <div>
                <h2 className={`text-[#9498A3] ${active=="Parent" ? 'text-[#EB5757]':""}`} onClick={()=>setActive("Parent")}>Parent-Child Profiles</h2>
                {active=="Parent" && <p className='px-8 bg-[#EB5757] p-[3px] mt-2 rounded'></p>}
                </div>
