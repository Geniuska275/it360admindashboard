    ...
    <div>
          ...
          <div className=' bg-white  py-4 shadow-md w-full top-0 sticky z-10'>
                           ...
                           <div className='flex gap-3  items-center px-1'>
                             ...
                             <h2 className=' px-2 text-[#71717A]'>Manage Instructor</h2>
                             </Link>
                               <IoIosArrowForward/>
                             <h2 className=' px-2 text-black font-bold'>James Umaru</h2>
        ...
        <div className='bg-white shadow-md p-2 my-5 relative h-[210px]'>
            <div className='grid grid-cols-4 gap-4'>
                ...
                <Separator my="1" size="4" orientation="vertical" />
                    ...
                    <h1 className='font-bold  '>
                     ...
                     <p className='text-[12px] text-[#9498A3] uppercase'>COURSE</p>
                    </div>
            ...
            <div className='mt-4 flex gap-2 py-4 mx-5 absolute' >
                ...
                {active=="Profile Details" && <p className='px-8 bg-[#EB5757] p-[3px] mt-2 rounded'></p>}
                 ...
                 <div>
                <h2 className={`text-[#9498A3] ${active=="Parent" ? 'text-[#EB5757]':""}`} onClick={()=>setActive("Students")}>All Students</h2>
                {active=="Students" && <p className='px-8 bg-[#EB5757] p-[3px] mt-2 rounded'></p>}
                </div>
             ...
             <div className='bg-white shadow-md p-4 my-5 rounded-xl '>
                ...
                <div className='grid grid-cols-5 gap-3 mx-5'>
                     <div>
                            ...
                            <p className='text-[12px] font-bold text-black'>James</p>
                        </div>
                        <div>
                             <h2 className=' text-[#9498A3] uppercase '>last Name</h2>
                            <p className='text-[12px] font-bold text-black'>Umaru</p>
